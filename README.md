...
- [ ] Update `mix release` to take an arg `maj | min | patch` and then have it do all the necessary `gh` calls and file changes to increase the version number and initiate the release of the next version, including the change long stuff.
